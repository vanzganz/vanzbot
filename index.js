...
/////////////////
const BotName = 'VANZ BOT☄'; 
const instagram = 'https://instagram.com/vanz_store_'; 
const telegram = 'https://t.me/fachry fachmy'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'https://youtu.be/aFebhZeD1nQ';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@vanz_store_')
